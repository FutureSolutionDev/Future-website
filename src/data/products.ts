...
export const Products: TProduct[] = [
  // ── LIVE ────────────────────────────────────────────────────────────────
  {
    ...
    tagline: {
      en: "Egypt's new-cities property data — updated daily, sent to your client in seconds.",
      ar: "بيانات عقارات المدن الجديدة في مصر — محدثة يومياً، وتوصل لعميلك في ثواني.",
    },
    description: {
      en: "Master V is a two-sided real estate platform. Brokers get a daily-updated database of compounds, units, prices, and full payment plans — with one-tap WhatsApp sending, an investment ROI calculator, and commission tracking with tax breakdowns. Home buyers get their own consumer version to browse projects and payment plans directly. Both sides ship with mobile apps coming to the stores soon.",
      ar: "Master V منصة عقارية بوجهين: البروكرز بيستخدموا قاعدة بيانات محدثة يومياً للكمبوندات والوحدات والأسعار وخطط السداد الكاملة — مع إرسال واتساب بضغطة، حاسبة عائد استثماري، وتتبع عمولات بحساب الضرائب. والمشتري النهائي له نسخة موجهة ليه يتصفح منها المشاريع وخطط السداد مباشرة. والنسختان ليهما تطبيقات موبايل قريباً على المتاجر.",
    },
    audience: {
      en: "Real estate brokers, agencies, and home buyers in Egypt's new cities.",
      ar: "البروكرز وشركات الوساطة والمشترين في المدن الجديدة بمصر.",
    },
    features: [
      {
      ...
      {
        en: "A consumer-facing version for buyers, white-labeled per partner",
        ar: "نسخة موجهة للمشتري النهائي، بهوية مستقلة لكل شريك",
      },
    ],
    stats: [
      { value: "10,000+", label: { en: "Brokers on the platform", ar: "بروكر على المنصة" } },
      { value: "1,000+", label: { en: "Compounds covered", ar: "كمبوند مُغطى" } },
      { value: "15,000+", label: { en: "Units with live pricing", ar: "وحدة بأسعار حية" } },
      { value: "24h", label: { en: "Data refreshed daily", ar: "تحديث يومي للبيانات" } },
    ],
    imagesFolder: "/Products/master-v",
    links: [
      {
        key: "website",
        url: "https://masterv.net",
        label: { en: "Broker Platform", ar: "منصة البروكرز" },
      },
    ],
    appsComingSoon: true,
  },
  {
    slug: "adham-fathallah",
    ...
    tagline: {
      en: "Every new-cities project, price, and payment plan — in the buyer's hands, with an expert one tap away.",
      ar: "كل مشاريع المدن الجديدة بأسعارها وخطط سدادها — في إيد المشتري، والخبير على بُعد ضغطة.",
    },
    description: {
      en: "The consumer-facing edition of our real estate engine, launched under the brand of a leading Egyptian property marketer. Home buyers browse compounds and projects with up-to-date prices and payment plans, compare options, and reach a consultant directly. It's also living proof that the same platform can launch white-labeled under any partner's brand.",
      ar: "النسخة الموجهة للمستهلك من محرّكنا العقاري، مُطلقة بهوية واحد من أبرز المسوقين العقاريين في مصر. المشتري يتصفح الكمبوندات والمشاريع بأسعار وخطط سداد محدثة، يقارن بنفسه، ويوصل لمستشار مباشرة. وكمان دليل عملي إن نفس المنصة تتطلق White-label بهوية أي شريك.",
    },
    audience: {
      en: "Home buyers and property investors in Egypt's new cities — and partners who want their own branded version.",
      ar: "مشترو ومستثمرو العقارات في المدن الجديدة بمصر — والشركاء اللي عايزين نسخة بهويتهم.",
    },
    features: [
      {
    ...
    stats: [
      { value: "20,000+", label: { en: "Buyers on the platform", ar: "عميل على المنصة" } },
      { value: "1,000+", label: { en: "Compounds to browse", ar: "كمبوند متاح للتصفح" } },
      { value: "14+", label: { en: "Years of market experience behind the brand", ar: "سنة خبرة سوقية وراء العلامة" } },
    ],
    imagesFolder: "/Products/adham-fathallah",
