...
export default function ArticlePage() {
    ...
    if (!article) {
        return (
            <section className="py-20 bg-bg-dark min-h-screen flex items-center justify-center">
                        ...
                        {section.steps && (
                            <div className="space-y-4">
                                {section.steps.map((step, i) => (
                                    <div
                                        key={i}
                                        className={`flex items-start gap-4 p-5 bg-surface-dark rounded-xl border border-white/5 hover:border-cyan-glow/20 transition-colors ${isRTL ? 'flex-row-reverse' : ''}`}
                                    >
                        ...
                        {section.stats && (
                            <div className="grid grid-cols-3 gap-4">
                                {section.stats.map((stat, i) => (
                                    <div
                                        key={i}
                                        className="text-center p-6 bg-surface-dark rounded-xl border border-white/5"
                                    >
