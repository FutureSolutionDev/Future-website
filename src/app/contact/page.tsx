                            ...
                            <div className="bg-surface-dark border border-white/5 rounded-2xl p-6">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <span className="text-text-muted">contact@futuresolutions.dev</span>
                                    </div>
                                    <div className="flex items-center space-x-4">
                                        <div className="w-10 h-10 rounded-full bg-primary-blue/10 flex items-center justify-center text-primary-blue">
                                            <Phone size={20} />
                                        </div>
                                        <span className="text-text-muted">+966 50 000 0000</span>
                                    </div>
                                    <div className="flex items-center space-x-4">
                                        <div className="w-10 h-10 rounded-full bg-primary-blue/10 flex items-center justify-center text-primary-blue">
                                            <MapPin size={20} />
                                        </div>
                                        <span className="text-text-muted">Riyadh, Saudi Arabia</span>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
